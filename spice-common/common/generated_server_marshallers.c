...
void spice_marshall_msg_display_cclient_draw(SpiceMarshaller *m,SPICE_GNUC_UNUSED SpiceMsgCclientDraw *msg)
{
	SPICE_GNUC_UNUSED SpiceMarshaller *m2;
	SpiceMsgCclientDraw *src;
	src = (SpiceMsgCclientDraw *)msg;
	
	spice_marshaller_add_uint32(m, src->format); // 数据压缩模式，yuv or h264
